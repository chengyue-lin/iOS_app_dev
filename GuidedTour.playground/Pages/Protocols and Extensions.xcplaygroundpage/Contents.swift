...
protocol ExampleProtocol {
     ...
     var anotherVariable: Int { get set}
...
class SimpleClass: ExampleProtocol {
     ...
     var anotherVariable: Int = 6
     var anotherProperty: Int = 69105
    func setAnotherVariable(x: Int){
        anotherVariable = x
    }
     func adjust() {
...
struct SimpleStructure: ExampleProtocol {
     ...
     var anotherVariable: Int = 9
    mutating func setAnotherVariable(x: Int){
        anotherVariable = x
    }
     mutating func adjust() {
