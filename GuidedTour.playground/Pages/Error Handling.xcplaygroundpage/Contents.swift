...
do {
    ...
    print(printerResponse)
} catch PrinterError.onFire {//to execute the first catch block change the toPrinter to "Has on fire"
    print("I'll just put this over here, with the rest of the fire.")
} catch let printerError as PrinterError {//to execute the second catch block change the toPrinter to "Never Has Toner"
    print("Printer error: \(printerError).")
} catch {//to execute the second catch block change the toPrinter to "Out of Paper"
    print(error)
}
