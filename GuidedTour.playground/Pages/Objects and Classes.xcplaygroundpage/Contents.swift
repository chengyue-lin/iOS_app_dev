...
class Shape {
    ...
    let numSides = 3
    func triangle(numSides:Int)->String{
        return "Triangle with \(numSides) sides."
    }
}
...
var tri = shape.triangle(numSides: shape.numSides)
...
class Circule: NamedShape {
    ...
    override func simpleDescription() -> String {
        return "A square with sides of length \(2*3.14*Radius)."
    }
}
let test1 = Circule(Radius: 4.0, name: "my test circule")
test1.area()
