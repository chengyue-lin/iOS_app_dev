...
func compare(l1:Rank, l2:Rank)->String{
    
    if l1.rawValue > l2.rawValue{
        return "The larger rawValue is \(l1)."
    }else{
        return "The larger rawValue is \(l2)."
    }
...
let jack = Rank.jack
let jackRawVa = jack.rawValue
compare(l1: ace, l2: jack)
//: - Experiment:
...
let heartColoe = hearts.color()//try to commit and push
...
let tie = ServerResponse.tie("It is tie.")
...
let deck = threeOfSpades.fullDeck()
//: - Experiment:
